...
const SERVICES = [
    { name: 'Проверка чистоты сделок с недвижимостью', price: 'по договорённости' },
    { name: 'Юридическое сопровождение сделок', price: 'по договорённости' },
    { name: 'Составление и проверка юридических документов', price: 'по договорённости' },
    { name: 'Услуги юристов по лицензированию', price: 'по договорённости' },
    { name: 'Переводчики', price: 'по договорённости' },
];
                            ...
                            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                                    ...
                                    <div className="flex gap-6">
                                        <div className="relative">
                                            <Avatar className="w-32 h-32 border-4 border-white shadow-sm">
                                                ...
                                                <AvatarFallback className="bg-blue-100 text-blue-600 text-3xl font-bold">СЖ</AvatarFallback>
                                            </Avatar>
                                        ...
                                        <div className="pt-2">
                                            <h1 className="text-3xl font-bold mb-2">Светлана Жигер</h1>
                                            <div className="flex items-center gap-2 text-gray-500 mb-4">
                                                <MapPin className="w-4 h-4" />
                                                <span>Мюнхен, Мариенплац</span>
                                            </div>
                                            <div className="flex items-center gap-4">
                                                ...
                                                <span className="text-gray-400 text-sm">12 отзывов</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-gray-600 leading-relaxed">
                                        Юридическое сопровождение сделок, проверка чистоты сделок с недвижимостью.
                                        Составление и проверка юридических документов. Помощь в лицензировании.
                                        Также предоставляю услуги переводчика. Работаю в Мюнхене и Ландсхуте.
                                    </p>
                            ...
                            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                                ...
                                <div className="border-b border-gray-100 pb-6 mb-6">
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            <div className="font-bold">Михаил</div>
                                            <div className="text-xs text-gray-400">20 декабря 2025</div>
                                        </div>
                                    ...
                                    <p className="text-gray-600">
                                        Обращался за помощью при покупке квартиры. Светлана провела полную проверку документов, выявила риски. Сделка прошла успешно. Очень компетентный специалист!
                                    </p>
                                </div>
                            ...
                            <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 sticky top-24">
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-medium">с 2022 года</span>
                                    </div>
                                    <div className="flex justify-between items-center">
